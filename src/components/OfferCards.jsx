  ...
  return (
    <div className='h-auto py-12 gap-y-10 md:h-[60vh] flex justify-evenly flex-col md:flex-row items-center w-full bg-[#f6f4f4bb]'>
      ...
      {card_content.map((content,index) => (
        <div className={` max-w-[65%] md:max-w-[30%] xl:max-w-[20%] w-full text-white p-4 ${content.color} rounded-lg flex flex-col justify-center items-center text-center gap-y-4 h-[13rem] md:h-[17rem]`} key={index}> 
